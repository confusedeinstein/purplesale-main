...
contract FairLaunchTest is Test {
    ...
    function testCreateLaunchEther1() public {
        createLaunchEther(0, false);
    ...
    function testCreateLaunchEther2() public {
        createLaunchEther(0, false);
        vm.warp(2 hours);
        vm.prank(xlazer);
        fairLaunch.buyToken{value: 1 ether}(0, 1e18, address(0));
    ...
    function testCreateLaunchEther3() public {
        createLaunchEther(5, true);
        vm.warp(2 hours);
        vm.startPrank(xlazer);
        fairLaunch.buyToken{value: 1 ether}(0, 1e18, address(0));
    ...
    function testCreateLaunchPT1() public {
        createLaunchPT(0, true);
        vm.prank(alice);
    ...
    function testCreateLaunchPT2() public {
        createLaunchPT(0, false);
        vm.startPrank(alice);
        fairLaunch.whitelistAddress(0, xlazer);
    ...
    //test for affiliate commission & alt fee option
    function testCreateLaunchPT3() public {
        createLaunchPT(5, true);
        vm.prank(alice);
        fairLaunch.whitelistAddress(0, xlazer);
