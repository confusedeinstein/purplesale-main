...
contract SubscriptionTest is Test {
    ...
    function createSubEther(bool _devFeeInToken) public {
    ...
    function testCreateSubEther1() public {
        createSubEther(false);
    ...
    function testCreateSubEther2() public {
        createSubEther(false);
        vm.warp(2 hours);
        vm.prank(xlazer);
    ...
    function testCreateSubEther3() public {
        createSubEther(true);
        vm.warp(2 hours);
        vm.prank(xlazer);
        sub.buyToken{value: 3 ether}(0, 3e18);
    ...
    function createSubPT(bool _devFeeInToken) public {
    ...
    function testCreateSubPT1() public {
        createSubPT(true);
        vm.prank(alice);
    ...
    //test for multiple user buying, claiming tokens, handle after sale, dev commision
    function testCreateSubPT2() public {
        createSubPT(false);
        vm.startPrank(alice);
        sub.whitelistAddress(0, xlazer);
    ...
    //test for alt fee option
    function testCreateSubPT3() public {
        createSubPT(true);
        vm.startPrank(alice);
        sub.whitelistAddress(0, xlazer);
        sub.whitelistAddress(0, xlazer2);
